              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-grow flex flex-col">
                    ...
                    <div className="mt-auto flex flex-col sm:flex-row sm:items-end justify-between pt-4">
                      {/* Quantity Controls */}
              ...
              <div className="bg-white rounded-lg shadow sticky top-6">
                ...
                <div className="p-6">
                  ...
                  <Link href="/checkout" className="block w-full">
                    <Button className="w-full bg-blue-700 hover:bg-blue-800 text-white py-3 rounded-md flex items-center justify-center">
